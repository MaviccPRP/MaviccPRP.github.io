...
[<img class=" wp-image-237 " title="HTML-Markup_Css-float" alt="Tutorial_Css_float_1" src="{{ site.url }}/assets/floating/Tutorial_Css_float_14.png" width="771" height="711"  />]({{ site.url }}/assets/floating/Tutorial_Css_float_14.png)<figcaption class="wp-caption-text">HTML Markup für das CSS float Tutorial</figcaption></figure> 
...
[<img class=" wp-image-215" title="Tutorial CSS float" alt="Tutorial_Css_float_2" src="{{ site.url }}/assets/floating/Tutorial_Css_float_2.png" width="774" height="86"  />]({{ site.url }}/assets/floating/Tutorial_Css_float_2.png)<figcaption class="wp-caption-text">CSS Styling</figcaption></figure> 
...
[<img class="size-full wp-image-216" title="Tutorial float CSS" alt="Tutorial_Css_float_3" src="{{ site.url }}/assets/floating/Tutorial_Css_float_3.png" width="476" height="593"  />]({{ site.url }}/assets/floating/Tutorial_Css_float_3.png)<figcaption class="wp-caption-text">Seitendesign ohne float</figcaption></figure> 
...
[<img class="size-full wp-image-217" title="CSS Tutorial float" alt="Tutorial_Css_float_4" src="{{ site.url }}/assets/floating/Tutorial_Css_float_4.png" width="474" height="329"  />]({{ site.url }}/assets/floating/Tutorial_Css_float_4.png)<figcaption class="wp-caption-text">Seitendesign mit float</figcaption></figure> 
...
[<img class=" wp-image-218" title="CSS Tutorial float" alt="Tutorial_Css_float_5" src="{{ site.url }}/assets/floating/Tutorial_Css_float_5.png" width="795" height="29"  />]({{ site.url }}/assets/floating/Tutorial_Css_float_5.png)<figcaption class="wp-caption-text">CSS mit float</figcaption></figure> 
...
[<img class="size-full wp-image-219" title="CSS Tutorial float" alt="Tutorial_Css_float_6" src="{{ site.url }}/assets/floating/Tutorial_Css_float_6.png" width="479" height="398"  />]({{ site.url }}/assets/floating/Tutorial_Css_float_6.png)<figcaption class="wp-caption-text">Seitendesign mit float ohne clear</figcaption></figure> 
...
[<img class=" wp-image-220" title="Tutorial CSS float" alt="Tutorial_Css_float_7" src="{{ site.url }}/assets/floating/Tutorial_Css_float_7.png" width="711" height="322" />]({{ site.url }}/assets/floating/Tutorial_Css_float_7.png)<figcaption class="wp-caption-text">HTML Markup inklusive clear</figcaption></figure> 
...
[<img class=" wp-image-221" title="CSS Tutorial float" alt="Tutorial_Css_float_8" src="{{ site.url }}/assets/floating/Tutorial_Css_float_8.png" width="730" height="45"  />]({{ site.url }}/assets/floating/Tutorial_Css_float_8.png)<figcaption class="wp-caption-text">CSS mit clear</figcaption></figure> 
...
[<img class="size-full wp-image-222" title="Tutorial CSS float" alt="Tutorial_Css_float_9" src="{{ site.url }}/assets/floating/Tutorial_Css_float_9.png" width="499" height="336"  />]({{ site.url }}/assets/floating/Tutorial_Css_float_9.png)<figcaption class="wp-caption-text">Seitendesign mit float und clear</figcaption></figure> 
...
[<img class="size-full wp-image-223" title="Tutorial CSS float" alt="Tutorial_Css_float_10" src="{{ site.url }}/assets/floating/Tutorial_Css_float_10.png" width="514" height="487" />]({{ site.url }}/assets/floating/Tutorial_Css_float_10.png)<figcaption class="wp-caption-text">Beispiel :after</figcaption></figure> 
...
[<img class=" wp-image-224" title="CSS Tutorial float" alt="Tutorial_Css_float_11" src="{{ site.url }}/assets/floating/Tutorial_Css_float_11.png" width="738" height="278"  />]({{ site.url }}/assets/floating/Tutorial_Css_float_11.png)<figcaption class="wp-caption-text">CSS clearfix (ohne height: 0;)</figcaption></figure> 
...
[<img class=" wp-image-238" title="CSS Tutorial float" alt="Tutorial_Css_float_12" src="{{ site.url }}/assets/floating/Tutorial_Css_float_121.png" width="633" height="342"  />]({{ site.url }}/assets/floating/Tutorial_Css_float_121.png)<figcaption class="wp-caption-text">HTML Markup mit clearfix</figcaption></figure> 
...
[<img class="size-full wp-image-226" title="CSS Tutorial float" alt="Tutorial_Css_float_13" src="{{ site.url }}/assets/floating/Tutorial_Css_float_13.png" width="490" height="325" />]({{ site.url }}/assets/floating/Tutorial_Css_float_13.png)<figcaption class="wp-caption-text">Seitendesign mit float und clearfix</figcaption></figure> 
